...
| CHANGE-005 | Selected mouth dominance | The equipped mouth defines the neutral portrait/full-body mouth; named non-neutral expressions may continue to use expression-authored mouth curves. | Face-channel content mapping; starter generation; resolver/render regression; Studio preview/export | READY FOR REVIEW | TASK-017 | Four-mouth neutral portrait/full-body comparison plus representative expression row |
