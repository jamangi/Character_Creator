...
- [x] All automated suites and required visual baselines pass from a clean checkout.
- [x] No unresolved critical/high security, licensing, accessibility, or data-loss issue remains.
