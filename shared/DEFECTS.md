...
|---|---|---|---|---|---|---|
| DEFECT-001 | Animation | Base legs and shoes animate, but hair, tops, bottoms, outfits, outerwear, and accessories remain on their static pose or fail to share the body's vertical motion. | Rig/selector semantics; core resolution; starter assets; validator; visual artifacts | READY FOR REVIEW | TASK-011 | Automated per-frame scene/image differences plus Task 006 before/after motion sheet |
